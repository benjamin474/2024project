<template>
  <div class="header-bar">
    ...
    <div class="auth-buttons">
      ...
      <button v-if="!isLoggedIn" class="sign" @click="showRegisterModal">註冊</button>
...
export default {
  ...
  methods: {
    ...
    async register() {
      ...
      try {
        const response = await fetch('https://wos-data-analysis-backend.onrender.com/api/auth/register', {
          method: 'POST',
          headers: {
    ...
    async login() {
      ...
      try {
        const response = await fetch('https://wos-data-analysis-backend.onrender.com/api/auth/login', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
